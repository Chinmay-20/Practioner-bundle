...
from aspectawareprerocessor import AspectAwarePreprocessor
...
aap=AspectAwarePreprocessors(256,256)
(R,G,B)=([],[],[])
...
for (dType,paths,labels,outputPath) in datasets:
	...
	widgets=["Building Dataset: ",progress.Percentage()," ",progressbar.Bar()," ",progressbar.ETA()]
